 ...
 */
@Deprecated
public class StatusBarUtilFoJava {
    ...
    public static void setDefaultColor(Activity activity){
        if(CheckOSUtilsForJava.isMIUI()){
            setColor(activity, activity.getResources().getColor(R.color._white),0);
            setMiuiStatusBarDarkMode(activity,true);
        }else if(CheckOSUtilsForJava.isFlyme()){
            setColor(activity, activity.getResources().getColor(R.color._white),0);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                setColor(activity,activity.getResources().getColor(R.color._white),50);
            }
        }
    }
}
